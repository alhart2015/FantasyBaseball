...
The #325 head-to-head against the keeper-value chain lives in
`scripts/backtest_keeper_value.py`. Split out because the two bake-offs shared nothing
but an argparse namespace, and that sharing had already forced the breakout rule to be
written twice.

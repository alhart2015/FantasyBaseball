...
**3. [baseball-scout] Oopsy projection system inflates blend**
...
**4. [software-engineer] Simulation opponent picks use `iterrows()` — O(n*d)**
...
**5. [software-engineer] No config validation**
...
**6. [software-engineer] Empty player pool crashes `calculate_replacement_levels`**
...
**7. [software-engineer] AVG/ERA warning thresholds are useless**
AVG warning fires at `.260 * 0.6 = .156`. ERA warning fires at `3.60 * 1.67 = 6.0`. Neither will ever trigger during a real draft.

---

**8. [baseball-scout, data-scientist] Pitcher Ohtani gets wrong positions**
...
**9. [baseball-scout] IF slots excluded from UTIL replacement calculation**
`replacement.py` excludes IF from positional count. Shifts UTIL replacement by 0.167 SGP. Negligible impact.

---

**10. [software-engineer] `read_state` has no retry on Windows `PermissionError`**
...
**11. [baseball-scout] Track projection system disagreements**
...
**12. [baseball-scout] Apply hitter/pitcher balance correction to VAR**
...
**13. [software-engineer] Add tests for delta protocol critical path**
`compute_delta`, `serialize_board`, `read_board`, `write_board` are untested despite being draft-day critical.

---

**14. [baseball-scout] Leverage cap in in-season optimizer**
...
**15. [baseball-scout] Minimum IP enforcement in lineup optimizer**

...
def patched_refresh_environment(
    ...
    *,
    ...
    _canned_mc = {
        ...
        "category_risk": {
            cat: {"median_pts": 7.0, "p10": 4.0, "p90": 10.0, "top3_pct": 25.0, "bot3_pct": 20.0}
    ...
    patches = [
        ...
        patch(
            ...
            side_effect=_fetch_scoring_period,
        ),

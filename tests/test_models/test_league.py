...
def _snap(d: date, *teams: tuple[str, int]):
    ...
    entries = [
        StandingsEntry(name, f"k-{name}", rank, CategoryStats(r=100 + rank)) for name, rank in teams
    ]
    ...
    redis_store.write_standings_snapshot(
        ...
        _standings(
            ...
            [
                ...
                ("Rivals", "k-riv", 5, 95, 35, 100, 12, 0.265, 50, 700, 28, 4.10, 1.22),
            ],
        ),
    )
    redis_store.write_standings_snapshot(
        ...
        _standings(
            ...
            [
                ...
                ("Rivals", "k-riv", 4, 110, 38, 115, 16, 0.268, 56, 760, 31, 3.95, 1.19),
            ],
        ),
    )
        ...
        redis_store.write_standings_snapshot(
            ...
            _standings(
                ...
                [
                    ...
                    ("Rivals", "k-riv", 4, 110, 38, 115, 16, 0.268, 56, 760, 31, 3.95, 1.19),
                    ("Standings Only", "k-so", 6, 80, 30, 90, 10, 0.260, 45, 650, 22, 4.20, 1.25),
                ],
            ),
        )
